...
def parse_marketplace_payload(payload: Any, *, source_url: str | None = None) -> list[MarketplaceSkill]:
    repo_url = None
    repo_ref = None
    if source_url:
...
def _parse_plugin_source(source: Any, plugin_root: str | None) -> tuple[str | None, str | None, str | None]:
    repo_url = None
    repo_ref = None
    repo_path = None
