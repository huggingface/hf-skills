...
async def install_skill(source: str, selector: str, *, destination_root: Path) -> InstalledSkillRecord:
    ...
    install_dir = await operations.install_marketplace_skill(selected, destination_root=destination_root)
    try:
...
def install_skill_sync(source: str, selector: str, *, destination_root: Path) -> InstalledSkillRecord:
    return asyncio.run(install_skill(source, selector, destination_root=destination_root))
